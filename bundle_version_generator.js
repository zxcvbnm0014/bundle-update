...
var remoteUrl = 'http://reset.7yigame.com/bundle-demo/';
...
var doWork = function () {
    ...
    var destManifest = path.join(destFileDir, bundleDir + '.manifest');
    var destVersion = path.join(destFileDir, bundleDir + '-ver.manifest');
